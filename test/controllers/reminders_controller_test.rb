...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { expiry_date: @reminder.expiry_date, reminder_content: @reminder.reminder_content, reminder_type_id: @reminder.reminder_type_id } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { expiry_date: @reminder.expiry_date, reminder_content: @reminder.reminder_content, reminder_type_id: @reminder.reminder_type_id } }
